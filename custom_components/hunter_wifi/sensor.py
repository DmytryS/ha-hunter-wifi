...
SENSOR_DEFINITIONS = [
    ("state", "hunter_wifi_status", None, None, None, None),
    (
        "currentSet",
        "hunter_wifi_current_set",
        "A",
    ...
    (
        "temperature2",
        "hunter_wifi_temperature_socket",
        "°C",
        SensorStateClass.MEASUREMENT,
        SensorDeviceClass.TEMPERATURE,
        None,
...
class EVSEGroundStatus(CoordinatorEntity, SensorEntity):
    ...
    def __init__(
        ...
        self.coordinator = coordinator
        self.config_entry = config_entry
        self._attr_translation_key = "hunter_wifi_ground_status"
