...
SWITCH_DEFINITIONS = [
    ("groundCtrl", "hunter_wifi_control_pe"),
    ("restrictedMode", "hunter_wifi_restricted_mode"),
    ("evseEnabled", "hunter_wifi_evse_enabled"),
]
...
async def async_setup_entry(
    ...
    entities.append(
        EVSESimpleSwitch(coordinator, entry, "oneCharge", "hunter_wifi_one_charge")
    )
    entities.append(
        EVSESimpleSwitch(coordinator, entry, "aiMode", "hunter_wifi_adaptive_mode")
    )
...
class EVSEScheduleSwitch(CoordinatorEntity, SwitchEntity):
    ...
    def __init__(
        ...
        self.config_entry = config_entry
        self._host = coordinator.host
        self._attr_translation_key = "hunter_wifi_schedule"
